...
class Constants:
    ...
    frontwheel_encoder_zero_offset = math.radians(240.22)  # calibrated for straight-ahead position
    ...
    backwheel_power_scale_factor = 0.6  # Scale factor for back wheel speed control
    ...
    connection_idle_timeout = 1.5   # seconds of silence before Pi sends a connection-check ping
    connection_ack_timeout = 1.0    # seconds to wait for ping_ack before disabling the robot
