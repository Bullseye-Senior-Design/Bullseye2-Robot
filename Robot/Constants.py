...
class Constants:
    ...
    uwb_tag_data = [ UWBTagInfo(port="/dev/ttyACM1", id=1, offset=(-24.77 / 2 / 100, 22.225 / 2 / 100, 0.0)), # back left tag
                     UWBTagInfo(port="/dev/ttyACM0", id=0, offset=(24.77 / 2 / 100, -22.225 / 2 / 100, 0.0)) ] # front right tag
