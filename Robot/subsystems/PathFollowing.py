...
class PathFollowing(Subsystem):
    ...
    def start(self):
        ...
        self.Q_terminal_diag = np.array([5.0, 5.0, 5.0]) # [lateral, heading, longitudinal] terminal (last point) weights
        ...
        self.v_bounds = [Constants.rear_motor_top_speed*0.2, Constants.rear_motor_top_speed] 
